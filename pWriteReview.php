<?
    ...
    if(isSet($_POST['rate'])){
        ...
        //be overwirtten 
        $query = "REPLACE INTO ReviewForP (num, username, rating ,title, comment, email, judge)
        ...
        header("Location: http://www.campusclipper.com/CCVersion2/product.php?product=$num");
    }
?>